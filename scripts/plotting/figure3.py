...
def plot_results(df, domain):
    ...
    plt.savefig(f'../../results/figures/results_{domain}.svg')
...
def add_late_data(root, domain):
    ...
    for dataset, modality, n_img in itertools.product(datasets, modalities):
        model = "vit_b_medical_imaging" if domain == "medical" else "vit_b_lm"
