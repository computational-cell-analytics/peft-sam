...
HPA_MAP = {
    ...
    "Late-QLoRA (C-50%)": [46.08, 15.68],
    "Late-QLoRA (A-50%)": [53.09, 17.45],
    "Late-QLoRA (C-25%)": [51.97, 15.39],
    "Late-QLoRA (A-25%)": [52.22, 16.27],
    "Late-QLoRA (C-8%)": [44.68, 15.19],
    "Late-QLoRA (A-8%)": [44.65, 15.49],
}
...
PSFHS_MAP = {
    ...
    "Late-QLoRA (C-50%)": [14.20, 4.65],
    "Late-QLoRA (A-50%)": [14.80, 6.42],
    "Late-QLoRA (C-25%)": [10.75, 4.36],
    "Late-QLoRA (A-25%)": [9.16, 5.24],
    "Late-QLoRA (C-8%)": [9.20, 4.16],
    "Late-QLoRA (A-8%)": [9.31, 4.46],
}
